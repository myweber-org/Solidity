...
public:
    ...
    void display_matrix(const std::vector<std::vector<double>>& mat, 
                       size_t max_rows = 5, size_t max_cols = 5) const {
        ...
        if (display_rows < mat.size()) {
            std::cout << "... (" << mat.size() - display_rows << " more rows)" << std::endl;
        }
    }
    ...
    void benchmark_performance() {
        ...
        std::cout << "Parallel multiplication time: " << (end_time - start_time) 
                  << " seconds" << std::endl;
        
        std::cout << "\nFirst matrix (partial view):" << std::endl;
        display_matrix(matrix_a);
        
        std::cout << "\nSecond matrix (partial view):" << std::endl;
        display_matrix(matrix_b);
        
        std::cout << "\nResult matrix (partial view):" << std::endl;
...
int main() {
    try {
        ...
        const size_t cols_a = 600;
        const size_t rows_b = 600;
