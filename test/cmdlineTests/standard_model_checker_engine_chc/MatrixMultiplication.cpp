...
int main() {
    ...
    cout << "Matrix multiplication completed in " << elapsed << " seconds." << endl;
    
    cout << "Sample element C[0][0] = " << C[0][0] << endl;
    cout << "Sample element C[" << SIZE-1 << "][" << SIZE-1 << "] = " 
         << C[SIZE-1][SIZE-1] << endl;
