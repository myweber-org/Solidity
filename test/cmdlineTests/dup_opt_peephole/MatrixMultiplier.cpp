...
int main() {
    ...
    try {
        ...
        std::cout << "Sequential execution time: " << (endSeq - startSeq) << " seconds\n";
        
        auto startPar = omp_get_wtime();
        multiplier.multiplyParallel();
        auto endPar = omp_get_wtime();
        std::cout << "Parallel execution time: " << (endPar - startPar) << " seconds\n";
        
        std::cout << "Speedup factor: " << (endSeq - startSeq) / (endPar - startPar) << "\n";
