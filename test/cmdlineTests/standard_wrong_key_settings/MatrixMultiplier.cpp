...
public:
    ...
    void benchmarkMultiplication() {
        ...
        bool isValid = verifyResults(seqResult, result);
        
        std::cout << "\nBenchmark Results:\n";
        std::cout << "Sequential time: " << seqTime << " seconds\n";
        std::cout << "Parallel time: " << parTime << " seconds\n";
        std::cout << "Speedup: " << seqTime / parTime << "x\n";
        std::cout << "Verification: " << (isValid ? "PASSED" : "FAILED") << "\n";
    }

    void runFullDemo() {
        std::cout << "Matrix A dimensions: " << rowsA << "x" << colsA << "\n";
        std::cout << "Matrix B dimensions: " << rowsB << "x" << colsB << "\n";
        std::cout << "Result dimensions: " << rowsA << "x" << colsB << "\n\n";
