...
std::string calculateSHA256(const std::vector<unsigned char>& data) {
...
bool verifyDataIntegrity(const std::vector<unsigned char>& data, const std::string& expectedHash) {
...
int main() {
    ...
    bool isValid = verifyDataIntegrity(data, hash);
