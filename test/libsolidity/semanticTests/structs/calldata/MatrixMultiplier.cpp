...
int main() {
    ...
    auto sequentialTime = std::chrono::duration<double>(end - start).count();
    
    start = std::chrono::high_resolution_clock::now();
    auto resultParallel = multiplyMatricesParallel(matrixA, matrixB);
    end = std::chrono::high_resolution_clock::now();
    auto parallelTime = std::chrono::duration<double>(end - start).count();
    
    bool resultsMatch = verifyResults(resultSequential, resultParallel);
