...
int main() {
    ...
    std::cout << "Serial execution time: " << serialDuration.count() << " ms" << std::endl;
    std::cout << "Parallel execution time: " << parallelDuration.count() << " ms" << std::endl;
    std::cout << "Speedup: " << static_cast<double>(serialDuration.count()) / parallelDuration.count() << "x" << std::endl;
