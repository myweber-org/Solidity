...
int main() {
    ...
    std::cout << "Starting matrix multiplication with OpenMP parallelization..." << std::endl;
    ...
    double sampleValue = result[N/2][P/2];
    std::cout << "Sample value at position [" << N/2 << "][" << P/2 << "]: " << sampleValue << std::endl;
