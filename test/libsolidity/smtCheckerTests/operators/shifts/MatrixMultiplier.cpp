...
int main() {
    ...
    try {
        ...
        std::vector<std::vector<double>> sequentialResult(ROWS_A, std::vector<double>(COLS_B));
        ParallelMatrixMultiplier verifier(ROWS_A, COLS_A, ROWS_B, COLS_B);
        verifier.multiplySequential();
