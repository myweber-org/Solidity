...
bool verifyResult(const vector<vector<int>>& result1,
...
int main() {
    ...
    cout << "Parallel time: " << (endParallel - startParallel) << " seconds" << endl;
    cout << "Sequential time: " << (endSequential - startSequential) << " seconds" << endl;
    cout << "Speedup: " << (endSequential - startSequential) / (endParallel - startParallel) << "x" << endl;
    
    if (verifyResult(resultParallel, resultSequential)) {
        cout << "Results verified: Parallel and sequential outputs match." << endl;
    } else {
