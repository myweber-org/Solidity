...
int main() {
    ...
    std::cout << "Sequential execution time: " << (endSeq - startSeq) << " seconds" << std::endl;
    std::cout << "Parallel execution time: " << (endPar - startPar) << " seconds" << std::endl;
    std::cout << "Speedup factor: " << (endSeq - startSeq) / (endPar - startPar) << std::endl;
