...
int main() {
    ...
    std::vector<std::vector<double>> matrixA = ParallelMatrixMultiplier::generateRandomMatrix(N, N);
    std::vector<std::vector<double>> matrixB = ParallelMatrixMultiplier::generateRandomMatrix(N, N);
