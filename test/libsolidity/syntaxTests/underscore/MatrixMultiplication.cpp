...
void print_matrix_summary(const std::vector<std::vector<double>>& matrix, const std::string& name) {
    std::cout << name << " summary - First element: " << matrix[0][0] 
              << ", Last element: " << matrix.back().back() 
              << ", Dimensions: " << matrix.size() << "x" << matrix[0].size() << std::endl;
}
...
int main() {
    ...
    std::cout << "Matrix multiplication completed in " << execution_time << " seconds." << std::endl;
