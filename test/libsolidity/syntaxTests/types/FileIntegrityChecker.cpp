...
int main(int argc, char* argv[]) {
    if (argc < 3) {
        std::cout << "Usage: " << argv[0] << " <filepath> <expected_hash> | <filepath>" << std::endl;
        std::cout << "  Single argument: compute and print SHA-256 hash." << std::endl;
        std::cout << "  Two arguments: verify file against expected hash." << std::endl;
        return 1;
    }
